...
# Build reverse dictionary: synonym -> main title
title_mapping = {}
...
for json_file in json_files:
    ...
    # Commit after processing each file to avoid memory issues with large datasets
    conn.commit()

# Normalize experience (same as your original code)
...
# Add experience_years column and update values
cur.execute('''ALTER TABLE vacancies ADD COLUMN IF NOT EXISTS experience_years INTEGER[];''')
...
print("All JSON files processed and data normalized.")